...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Hirings', path: '/hirings', entity: 'hiring', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Jobs', path: '/jobs', entity: 'job', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Worklogs', path: '/worklogs', entity: 'worklog', service: AccessServiceEnum.PROJECT, icon: FiBox },
