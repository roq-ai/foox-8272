  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox - Empowering Freelancers, Enriching Companies. Your trusted job marketplace for freelance work, connecting talent with opportunity."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox - Empowering Freelancers, Enriching Companies. Your trusted job marketplace for freelance work, connecting talent with opportunity.`}
            </Text>
            <Box
